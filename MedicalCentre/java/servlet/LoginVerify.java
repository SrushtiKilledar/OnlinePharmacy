                ...
                if(flag==1){
                    ...
                    if( designationId==9){
                       ...
                       // response.sendRedirect("doctor_first_if.jsp");
                        ...
                        //getServletContext().getRequestDispatcher("/Registeration.jsp").forward(request, response);
                    }
                    /**
                     * commented on 16-03-2023
                     * else{
                            //to Register
                        getServletContext().getRequestDispatcher("/Registeration.jsp").forward(request, response);
                    }**/ 
                   ...
                   getServletContext().getRequestDispatcher("/login.jsp").forward(request, response);
                   // added this commit on 16-03-2023 along with upper comment for reflection purposes
                   getServletContext().getRequestDispatcher("/Registeration.jsp").forward(request, response);
                }
