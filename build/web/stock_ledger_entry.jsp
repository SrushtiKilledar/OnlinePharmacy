                            ...
                            <td width="50%">
                                <table class="entry_table" border="0" cellpadding="7" cellspacing="10" width="100%">
                                    <tr >
                                        ...
                                        <td class="td_right">
                                            <SELECT id="medicine_type" name="medicine_type">
                                                ...
                                                < <OPTION value="" selected> Tablet </OPTION>
                                                 <OPTION value="" selected> injection </OPTION>
                                                  <OPTION value="" selected> capsule </OPTION>                                                
                                                  <%
                                                    //ResultSet rs;
                                                    int n=1;
                                    ...
                                    <tr>
                                        ...
                                        <td class="td_center"> : </td>
                                        <td class="td_right">
                                            <input type="text" name="pp_price" id="pp_price" size="5">&nbsp;Price
                                        </td>
                                    </tr>
                                    <tr>
...
$(document).ready(function(){
    ...
    $('#medicine_type').change(function(){
            ...
            $.ajax({
               type: "POST",
               url: "http://localhost:8084/medical-center-master/GetMedInfo",
    ...
    $('#slmedAdd').click(function(){
       ...
       // alert(med_dr+'$'+med_dose+'$'+med_id);alert(med_inst);
           ...
           $.post("http://localhost:8084/medical-center-master/StocLedgerSubmit",
